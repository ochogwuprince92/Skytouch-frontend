...
const MOCK_CONVERSATIONS = [
{
  ...
  lastMessage: 'We would love to schedule an interview with you next week.',
  time: '10:30 AM',
  unread: 2,
  online: true
},
{
  ...
  lastMessage: 'Thanks for your application! I have a few quick questions.',
  time: 'Yesterday',
  unread: 1,
  online: false
},
{
  ...
  lastMessage: 'Your portfolio looks great. Are you available for a call?',
  time: 'Mon',
  unread: 0,
  online: true
}];
...
},
{
  id: 3,
  senderId: 1,
  text: 'Your background matches what we are looking for. We would love to schedule an interview with you next week.',
  time: '10:30 AM',
  isMe: false
}];
        ...
        <div className="p-4 border-b border-slate-200 bg-white flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">{activeChat.company}</p>
            </div>
          </div>
